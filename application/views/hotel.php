...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <!--  Este es el header -->
    <header class="intro-hotel">
        <h1 class="intro-h1"><span class="light">Hoteles</span></h1>
        <h3 class="intro-h3 "><em>"Elije entre los mejores hoteles de cada region. KOHANA Framework, Programacion IV"</em></h3>
    </header>
    ...
    <section class="sec-destinos">
        <div class="rows">
            <div class="col-md-12 text-center div-destino-a">
                <h1>HOTELES</h1>
                <h4>Disfruta de la comodidad y de la mejor atencion en los mejores hoteles a nivel mundia, por precios accesibles.</h4>
            </div>
        </div>
        <div class="rows">
            <div class="col-md-6 text-center div-destino" style="background: url(img/spain.jpg) no-repeat bottom center scroll;">
                <h2>HOTEL</h2>
                <h1>$35.00</h1>
                <a href="vuelos.php"><span class="btn-estructurado">RESERVAR</span></a>
            </div>
            <div class="col-md-6 text-center div-destino" style="background: url(img/alemania.jpg) no-repeat bottom center scroll;">
                <h2>HOTEL</h2>
                <h1>$15.00</h1>
                <a href="vuelos.php"<span class="btn-estructurado">RESERVAR</span></a>
            </div>
            <div class="col-md-6 text-center div-destino" style="background: url(img/brasil.jpg) no-repeat bottom center scroll;">
                <h2>HOTEL</h2>
                <h1>$20.00</h1>
                <a href="vuelos.php"><span class="btn-estructurado">RESERVAR</span></a>
            </div>
            <div class="col-md-6 text-center div-destino" style="background: url(img/estadosunidos.jpg) no-repeat bottom center scroll;">
                <h2>HOTEL</h2>
                <h1>$5.00</h1>
                <a href="vuelos.php"><span class="btn-estructurado">RESERVAR</span></a>
            </div>
